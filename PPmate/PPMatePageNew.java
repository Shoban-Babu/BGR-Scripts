...
public class PPMatePageNew extends BasePage {

	private final static String FILE_NAME = "resources/ReFactoring/PPMateNew.properties";
	...
	public void navigateToTopupPage(){
		...
		if(browser.isElementVisibleWithXpath(pageProperties.getProperty("PPMate.Topupbutton"))){
			System.out.println("VVVVVVVVVVVVVVVVVVVVVVVVVVVVV");
			verifyAndClickWithXpath(pageProperties.getProperty("PPMate.Topupbutton"),"Topup Yourself Link");
	...
	public void EnterTopupamount(){
		browser.wait(getWaitTime());
		verifyAndInputByXpath(pageProperties.getProperty("PPMate.EnterAmount"), "TopUpAmount", "5");
	...
	public void AddPaymentCard(){
		...
		if(browser.isElementVisibleWithXpath(pageProperties.getProperty("PPMate.AddPaymentCardNew"))){
			verifyAndClickWithXpath(pageProperties.getProperty("PPMate.AddPaymentCardNew"),"Add a Payment Card Link");
			Report.updateTestLog("Add a Payment Card Link is clicked successfully", "WARN");
		}
		else{
			Report.updateTestLog("Add a Payment Card Link is not present in an application", "Fail");
	...
	public void navigateToManagePaymentCardsPage() {
		...
		verifyAndClickWithXpath(pageProperties.getProperty("PPMate.Topupbutton"), "Manage Payment Card");
	  ...
	  public void AddPaymentcardFunctionality(){
		  verifyAndInputByXpath(pageProperties.getProperty("PPMate.CardNumber"), "CardNumber", "4539915929675909");
		  ...
		  verifyAndInputByXpath(pageProperties.getProperty("PP.Mate.CVV"), "CVV", "123");
		  Report.updateTestLog("Add New card Details entered successfully", "WARN");
		  if(browser.isElementVisibleWithXpath(pageProperties.getProperty("PPMate.submitButton"))){
				verifyAndClickWithXpath(pageProperties.getProperty("PPMate.submitButton"),"Submit Button");
	  ...
	  public void goToYourAccountbutton(){
		  verifyAndClickWithXpath(pageProperties.getProperty("PPMate.Gotouraccount"), "Go To Your Account Link");
	  }
