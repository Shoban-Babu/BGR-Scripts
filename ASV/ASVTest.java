...
//////////////////////////////////////////////////////////////////////////////Done - Done - August 21 st Release //////////////////////////////////////////////

                        @Test(groups = { ASVIB , Regression })	
                        public void asvBookingafter54days(){
                     	   Report.createTestLogHeader("ASV End To End through calendar", "HomeServciesAccount"); 
                     	   UserProfile userProfile = new TestDataHelper().getUserProfile("HomeServicesAccount");
                     		new HomePageAction()
 							.navigateToLogin()
                     	    ...
                     	    new ASVAction()
                     	    .navigateToAsvBookingPage(userProfile)
                     	    .verifyAppointmentSlots()
                     	    .navigateToAppointmentconfirmationPage()
                     	   .logout();
                     	 }
                        
                        
                        @Test(groups = { ASVIB , Regression })	
                        public void asvBookingReschedule_54daysAccount(){
                     	   Report.createTestLogHeader("ASV Reschedule the Booking calendar", "HomeServciesAccount"); 
                     	   UserProfile userProfile = new TestDataHelper().getUserProfile("HomeServciesAccount");
                     		new HomePageAction()
 							.navigateToLogin()
 							.loginUserDetails(userProfile);
