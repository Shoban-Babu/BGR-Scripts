...
public class ASVAction {
	...
	public ASVAction verifyAppointmentSlots()
	{
		new ASVPage().verifyAppointmentSlots();
		return this;
	}
	public ASVAction navigateToAppointmentconfirmationPage()
	{
		new ASVPage().navigateToAppointmentconfirmationPage();
		return this;
	}
