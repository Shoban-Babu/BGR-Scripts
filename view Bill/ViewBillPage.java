...
public class ViewBillPage extends BasePage{
	...
	public void viewDifferentStatements(){
		Report.updateTestLog("view Statement page", "WARN");
	...
	public void NavigatingToLinks(int i)
	{
		...
		verifyIsElementVisibleWithXpath(pageProperties.getProperty("ViewBill.MeterReadHistoryLinknew"), "Hi....Submit Meter Read Link");
		}
		else{
		//verifyAndClickWithXpath(pageProperties.getProperty("ViewBill.MeterReadHistoryLink"), BillDate, "Meter Read History Link");
			verifyAndClickWithXpath(pageProperties.getProperty("ViewBill.MeterReadHistoryLinknew"), BillDate, "Meter Read History Link");
	...
	public void navigatetoElectricity() {
		...
		verifyAndClickWithXpath(pageProperties.getProperty("ViewBill.Go1"), "Go");
		Report.updateTestLog("Electricity Selected from Dropdown", "WARN");
	}
