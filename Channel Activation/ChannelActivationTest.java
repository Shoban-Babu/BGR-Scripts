...
@Test(groups = { FunctionalCategory.Acquisition })
public void registerIntSingleDual2_old() {

	Report.createTestLogHeader("Channel Activation","Single Dual account Register Interest 2");
	UserProfile userProfile = new TestDataHelper()
 ...
 ***************************************************************************/
		...
		//////////////////////////////////////////////////////////////////////// July 7 the Release ////////////////////////////////////////////////////
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		/////////////////////////////////////// Verify in the BGMO Data the new question is added///////////////////////////////////////  
		
		@Test(groups = { FunctionalCategory.Acquisition })
		public void ExCustCASignUpDualPrePayFF_BGMOAccount(){
			Report.createTestLogHeader("BGMO Account","Existing Duel Fuel Cust Energy Shop");
			UserProfile userProfile = new TestDataHelper().getUserProfile("DualAccount");
			String ExQues4="YES";
			String ExQues5 ="NO";
			String Account="Single";
			...
			new ChannelActivationAction()
				.exclickSmartMeterLink(userProfile,Account)
				.exScreeningQuesNew(userProfile,ExQues4,ExQues5)
				.exClickConfrmAddContinue()
				.verifyChooseYourAppointmentPage()
			    .navigateToReviewYourAppointmentPageFirstAvailableAppointment()
			    .verifyRevieweDtailsPage(meterReadFrequency)
		...
		@Test(groups = { FunctionalCategory.Acquisition })
		public void Verify_BGMOAccount_ErrorMessage(){
			Report.createTestLogHeader("BGMO Account","Existing Duel Fuel Cust Energy Shop");
			UserProfile userProfile = new TestDataHelper().getUserProfile("DualAccount");
			String ExQues4="YES";
			String ExQues5 ="YES";
...
//////////////////////////////////// In the July 7th Release -the Change is --> In the "Register your interest in smart meters" Page 
///////////////////////////////////  Return to your account button should not available		
