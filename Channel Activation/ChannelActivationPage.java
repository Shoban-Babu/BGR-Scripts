	  ...
	  /*************************************************************
		...
		**************************************************************/			
			...
			public void newCustScreeningQues(String outstandingBalance,String Eco7,String Flat,String FuseBox,String Smart){
				...
				Report.updateTestLog("into new cust screening quests", "WARN");
		...
		public void newCusFlowDecider(Acquisition acquisition,UserProfile userProfile,String AddressDD, String outstandingBalance,String Eco7,String Flat,String FuseBox,String Smart,String Tariff,String paymentType){
			...
			if((outstandingBalance=="No")&&(Eco7=="No")&&(Flat=="No")&&(FuseBox=="Yes")&&(Smart=="No")){
				...
				if(browser.isElementVisibleWithXpath(pageProperties.getProperty("ChannelActivation.newContinueToGAQ"))){
					Report.updateTestLog("Continue to Get a Quoate Link Exists", "WARN");
					browser.wait(10000);
		...
		public void tellAbtYou(UserProfile userProfile,String AddressDD){
			 ...
			 if (browser.isElementVisible(pageProperties.getProperty("ChannelActivation.NewSelectTitle"))) {
	    		 String dropdata=browser.getTextByXpath(pageProperties.getProperty("ChannelActivation.NewSelectTitleDropdown"));
	    	        ...
	    	        Report.updateTestLog("Title has been Entered successfully" , "WARN");
	    	    } else {
			...
			verifyAndInputById(pageProperties.getProperty("ChannelActivation.NewPostalCode"), "Postal Code",userProfile.getPostCode());
			...
			browser.WaitForElementWithId(pageProperties.getProperty("ChannelActivation.NewSelectAddress"));
			 ...
			 if (browser.isElementVisible(pageProperties.getProperty("ChannelActivation.NewSelectAddress"))) {
	    	  ...
	    	  Select select = new Select(browser.getElementByXpath(pageProperties.getProperty("ChannelActivation.EmailWorkType")));
		...
		**************************************************************/
		...
		public void inEligibleReasonExists(){
			...
			{
				Report.updateTestLog("In Eligible Reasons Exists -------", "WARN");
				}
			else{
			...
			/*if(browser.isElementVisibleWithXpath(pageProperties.getProperty("ChannelActivation.InEligibleReasons1"))){
				...
				Report.updateTestLog("In Eligible Reasons1 Exists", "WARN");
				}else{
					Report.updateTestLog("In Eligible Reasons not Exists *******", "FAIL");
					}*/
		...
		**************************************************************/
		...
		public void Clicksubmit(){
			Report.updateTestLog("Register Your Intrest Page", "WARN");
			if(browser.isElementVisibleWithXpath(pageProperties.getProperty("ChannelActivation.InEligibleSubmitReturnNew"))){
				Report.updateTestLog("Return To Your Account is available", "FAIL");
				}else{
					Report.updateTestLog("Return To Your Account is not available", "PASS");
					}
			if(browser.isElementVisibleWithXpath(pageProperties.getProperty("ChannelActivation.Submitbutton"))){
				verifyAndClickWithXpath(pageProperties.getProperty("ChannelActivation.Submitbutton"), "Submit Button");
				Report.updateTestLog("British Gas Check Box Checked", "PASS");
				}else{
					Report.updateTestLog("British Gas Check Box not Checked", "FAIL");
					}
		...
		**************************************************************/
		...
		public void InEligibleSubmitReturn(){
			...
			verifyAndClickWithXpath(pageProperties.getProperty("ChannelActivation.InEligibleSubmitReturnNew"), "InEligible Submit Return to Account");
		}
		/*************************************************************
		Created By          : Vishnu Prasad D
		Created Date        : 03/26/2014
		...
		**************************************************************/	
		...
		public void exScreeningQues(UserProfile userProfile,String ExQues1,String ExQues2){
			if(ExQues1=="YES"){
				...
				if(browser.isElementVisible(pageProperties.getProperty("ChannelActivation.ExScreeningQues1YesNew"))){
					                                             			
				//verifyAndClick(pageProperties.getProperty("ChannelActivation.ExScreeningQues1Yes"), "Ex Cust Screening Ques 1 Yes");
					verifyAndClick(pageProperties.getProperty("ChannelActivation.ExScreeningQues1YesNew"), "Ex Cust Screening Ques 1 Yes");
				}else{
		...
		public void exScreeningQuesNew(UserProfile userProfile,String ExQues4,String ExQues5){
			if(ExQues4=="YES"){
				if(browser.isElementVisible(pageProperties.getProperty("ChannelActivation.EXEleigibleMeterYes"))){
				verifyAndClick(pageProperties.getProperty("ChannelActivation.EXEleigibleMeterYes"), "Select Yes for the meter box easily accessible");
				}else{
					Report.updateTestLog("Ques4 Yes does not exists", "FAIL");
					}
			}
			if(ExQues4=="NO"){
				if(browser.isElementVisible(pageProperties.getProperty("ChannelActivation.EXEleigibleMeterNo"))){
				verifyAndClick(pageProperties.getProperty("ChannelActivation.EXEleigibleMeterNo"), "Select No for the meter box easily accessible");
					}else{
						Report.updateTestLog("Ques4 No does not exists", "FAIL");
						}
			}
			
			if(ExQues5=="YES"){
				if(browser.isElementVisible(pageProperties.getProperty("ChannelActivation.ExChooseQuestionSolarQtnYes"))){
				verifyAndClick(pageProperties.getProperty("ChannelActivation.ExChooseQuestionSolarQtnYes"), "Ex Cust Screening Ques 4 Yes");
					}
				else{
					Report.updateTestLog("Ques5 Yes does not exists", "FAIL");
					}
			}
			if(ExQues5=="NO"){
				if(browser.isElementVisible(pageProperties.getProperty("ChannelActivation.ExChooseQuestionSolarQtnNo"))){
				verifyAndClick(pageProperties.getProperty("ChannelActivation.ExChooseQuestionSolarQtnNo"), "Ex Cust Screening Ques 4 No");
					}
				else{
					Report.updateTestLog("Ques5 Yes does not exists", "FAIL");
					}
		...
		**************************************************************/	
		public void exClickConfrmAddContinue(){
			...
			Report.updateTestLog("Select to book smart meter", "WARN");
		...
		**************************************************************/	
		public void verifyRevieweDtailsPage(String meterReadFrequency){
			...
			verifyAndClickWithXpath(pageProperties.getProperty("ChannelActivation.IsThereWeNeedToKnow_New"), "Is There We Need To Know");
			verifyAndClickWithXpath(pageProperties.getProperty("ChannelActivation.Seemoreoptions"), "See more options");
			browser.wait(3000);
		...
		**************************************************************/	
		...
		public void exVerifyApnmtConfirm(UserProfile userProfile){
			Report.updateTestLog("Appointment confirmation Page", "WARN");
