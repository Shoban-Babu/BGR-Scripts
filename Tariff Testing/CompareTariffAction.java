...
public class CompareTariffAction {
	...
	public CompareTariffAction verifyCompareTariffPageElect(String Registers,String tariff, String payment ,String postCode,String DualFuel){
		new CompareTariffPage().verifyCompareTariffPageElect(Registers,tariff,payment,postCode,DualFuel);
		return new CompareTariffAction();
	}
