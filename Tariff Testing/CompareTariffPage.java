...
public class CompareTariffPage extends BasePage {
    ...
    public void verifyCompareTariffPageElect(String Registers,String tariff, String payment, String postCode,String DualFuel){
		verifyAndInputByXpath(pageProperties.getProperty("CompareTariff.postCodeFeild"),"post code",postCode);
		browser.wait(5000);
		String region1 = postCode;
		String Region = new TCRCalculationPage().getPostcode(region1);
		...
		selectMeterNew(Registers);
			...
			verifyAndClickWithXpath(pageProperties.getProperty("CompareTariff.viewInformation"),"View Tariff Information clicked successfully");
			browser.wait(getWaitTime());
			verifyTILforTariffElectNew(payment,Region,Registers,tariff,postCode,DualFuel);
		
	}	
    
    public void selectMeterNew(String Registers){
    	if(Registers == "0002"){
    		//verifyAndClickWithXpath(pageProperties.getProperty("CompareTariff.economy7"),"Economy 7 is checked in");
    		System.out.println("It is 0002");
    	}
    } 
    
    public void verifyTILforTariffElectNew(String payment, String Region,String Registers,String tariff, String postCode,String DualFuel){
    	Report.updateTestLog("*********************    Dual Fuel "+DualFuel+"   **********************", "Pass");	
    	if (Registers == "0002"){
    		verifyTILforElec2RTariffNew(payment,Region,Registers,tariff,postCode,DualFuel);
    
    	}
    		//verifyTILforElecSRTariffNew(payment,Region,Registers,tariff,postCode,DualFuel);
    	}
    	
    public void verifyTILforElec2RTariffNew(String payment, String Region,String Registers, String tariff,String postCode,String DualFuel){
    	String Fuel = "01";
    ...
    ///// verifying standing charges /////
    	...
    	System.out.println("Statnding Charge is"+ standingChargeOnScr);
