...
public class repairAndCoverAction {
	...
	public repairAndCoverAction enteringLoginContactDetails(UserProfile userProfile,Acquisition acquisition ){
		repairAndCoverPage CoverPage = new repairAndCoverPage(custType,boilerType,paymentType,addrType);
		CoverPage.enteringLoginContactDetails(userProfile,acquisition);
		return new repairAndCoverAction();
	}
