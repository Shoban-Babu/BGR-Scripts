...
////////////////////////////////June 23rd Release //////////////////////////////////////////////
///////// Verifying the Collect Points Banner is removed now//////////////////////////////////
				
				@Test(groups = { SubmitMeterRead,Regression,InProgress })
			 public void submitPlausibleElecMeter_VerifyNectar() {
				Report.createTestLogHeader("Submit Meter Read.", "Plausible Electricity Meter and Verify the Nectar Banner");
				...
				userProfile.setAccNumber(userProfile.getElecAccount());
				        ...
				        .navigateToAccountSummaryPage(userProfile)
				        .navigateToSMRPage()
				        .setPlausbileReadingNew(userProfile.getElecAccount())
				        .confirmAccountSelection_New()
				        .logoutNew();

			}
				
				@Test(groups = { SubmitMeterRead,Regression,InProgress })
				 public void submitPlausibleGasMeter_VerifyNectar() {
					Report.createTestLogHeader("Submit Meter Read.", "Plausible Gas Meter and Verify the Nectar Banner");
				 ...
				 @Test(groups = { SubmitMeterRead,Regression })
					public void submitImPlausibleElecMeter_VerifyNectar() {
						Report.createTestLogHeader("Submit Meter Read.", "Implaussible Electricity Meter and Verify the Nectar Banner");
						...
						.navigateToAccountSummaryPage(userProfile)
						.navigateToSMRPage()
						.setImPlausbileReading_New(userProfile.getAccNumber())
						.confirmAccountSelection_New()
				        .logoutNew();
				 ...
				 @Test(groups = { SubmitMeterRead,Regression })
					public void submitImPlausibleGasMeter_VerifyNectar() {
						Report.createTestLogHeader("Submit Meter Read.", "Implaussible Gas Meter and Verify the Nectar Banner");

						UserProfile userProfile = new TestDataHelper()
						        .getUserProfile("AnonymousGasAccount");
