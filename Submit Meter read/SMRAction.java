...
public class SMRAction {
	...
	public SMRAction navigateToSMRReadPage() {

		submitMeterReadPage.navigateToSMRReadPage();
		return this;
	...
	public SMRAction setPlausbileReadingNew(String accountNumber) {
		submitMeterReadPage.setPlausbileReadingMeterReadNew(accountNumber);
		return this;
	...
	public SMRAction setImPlausbileReading_New(String accountNumber) {
		submitMeterReadPage.setImPlausbileReadingHigh_New(accountNumber);
		return this;
	}
...
public SMRAction verifySmartMeterLinkAtMeterReadingPage() {
	...
	public AccountOverviewAction confirmAccountSelection_New() {
		new SubmitMeterReadPage().confirmAccountSelection_New();
		return new AccountOverviewAction();
	}
