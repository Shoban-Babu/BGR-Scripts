...
public class MakeAPaymentActionNew {
    ...
    public MakeAPaymentActionNew VerifyClickMakeaPayment(){    	
    	makeAPaymentPage.ClickMakeaPayment();
    	return this;
    }
    public MakeAPaymentActionNew EnterCVVNumber(){    	
    	makeAPaymentPage.EnterCVVNumber();
    	return this;
    }
    ...
    public MakeAPaymentActionNew makeAPaymentJourney_new(int cardtype){    	
    	makeAPaymentPage.makeAPaymentJourney_new(cardtype);
    	return this;
    }
}
