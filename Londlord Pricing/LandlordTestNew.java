...
public class LandlordTestNew extends TestBase{
	...
	public void verifyLandlordMultipleProperty(){
		...
		String[] LandLordPackage = {"Gas Safety Check and Certificate","HomeCare One with a Gas Safety Certificate","HomeCare Two with a Gas Safety Certificate","HomeCare Three with a Gas Safety Certificate","HomeCare Four with a Gas Safety Certificate"};
		for(int i=0;i<5;i++){
			new LandlordActionNew()
			.navigateLandLordPage()
	...
	public void verifyAnonymousNationalLandlordPackagePricingWithoutBoilerCover(){
		Report.createTestLogHeader("LandLord Journey", "Verify Anonymous National Landlord Package Pricing Without BoilerCover");
		LandLord Landlord= new TestDataHelper().getLandLord("single");
	...
	public void verifyAnonymousLondonLandlordPackagePricingWithoutBoilerCover(){
		Report.createTestLogHeader("LandLord Journey", "verify Anonymous London Landlord Package Pricing Without Boiler Cover");
		LandLord Landlord= new TestDataHelper().getLandLord("single");
		boolean BoilerCover = false;
		new LandlordActionNew()
			.navigateLandLordPage()
	...
	public void verifyAnonymousNationalLandlordPackagePricingWithBoilerCover(){
		Report.createTestLogHeader("LandLord Journey", "verify Anonymous National Landlord Package Pricing With Boiler Cover");
		LandLord Landlord= new TestDataHelper().getLandLord("single");
	...
	public void verifyAnonymousLondonLandlordPackagePricingWithBoilerCover(){
		Report.createTestLogHeader("LandLord Journey", "verify Anonymous London Landlord Package Pricing With Boiler Cover");
		LandLord Landlord= new TestDataHelper().getLandLord("single");
		boolean BoilerCover = true;
		new LandlordActionNew()
			.navigateLandLordPage()
...
//////////////////////////////////////////////Pricing region changes - Logged in - HEMASUNDAR J /////////////////////////////////////////////////////////////////////
    ...
    public void verifyOAMNationalLandlordPackagePricingWithoutBoilerCover(){
           Report.createTestLogHeader("LandLord Journey", "verify OAM National Landlord Package Pricing Without Boiler Cover");
           LandLord Landlord= new TestDataHelper().getLandLord("single");
           UserProfile userProfile = new TestDataHelper().getUserProfile("GasAccount");
           boolean BoilerCover = false;
             new HomePageAction()
    ...
    public void verifyOAMLondonLandlordPackagePricingWithoutBoilerCover(){
           Report.createTestLogHeader("LandLord Journey", "verify OAM London Landlord Package Pricing Without Boiler Cover");
           LandLord Landlord= new TestDataHelper().getLandLord("single");
           UserProfile userProfile = new TestDataHelper().getUserProfile("GasAccount");
           boolean BoilerCover = false;
             new HomePageAction()
    ...
    public void verifyOAMNationalLandlordPackagePricingWithBoilerCover(){
           Report.createTestLogHeader("LandLord Journey", "verify OAM National Landlord Package Pricing With Boiler Cover");
           LandLord Landlord= new TestDataHelper().getLandLord("single");
    ...
    public void verifyOAMLondonLandlordPackagePricingWithBoilerCover(){
           Report.createTestLogHeader("LandLord Journey", "verify OAM London Landlord Package Pricing With Boiler Cover");
           LandLord Landlord= new TestDataHelper().getLandLord("single");
           UserProfile userProfile = new TestDataHelper().getUserProfile("ElectricityAccount");
           boolean BoilerCover = true;
             new HomePageAction()
